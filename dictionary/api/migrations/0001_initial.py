# -*- coding: utf-8 -*-
# Generated by Django 1.11.2 on 2017-06-06 06:27
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('text', models.CharField(max_length=1000)),
                ('featured_artists', models.ManyToManyField(blank=True, related_name='_example_featured_artists_+', to='api.Artist')),
            ],
            options={
                'ordering': ['text'],
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('mentioned_in', models.ManyToManyField(blank=True, related_name='mentions_place', to='api.Example')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('mentioned_in', models.ManyToManyField(blank=True, related_name='mentions_sense', to='api.Example')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('featured_artists', models.ManyToManyField(blank=True, related_name='_song_featured_artists_+', to='api.Artist')),
                ('owner', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='songs', to=settings.AUTH_USER_MODEL)),
                ('primary_artists', models.ManyToManyField(related_name='_song_primary_artists_+', to='api.Artist')),
            ],
            options={
        ...
        migrations.AddField(
            ...
            field=models.ManyToManyField(related_name='_example_primary_artists_+', to='api.Artist'),
        ),
        migrations.AddField(
            model_name='domain',
            name='senses',
        ...
        migrations.AddField(
            model_name='artist',
            name='mentioned_in',
            field=models.ManyToManyField(blank=True, related_name='mentions_artist', to='api.Example'),
        ),
        migrations.AddField(
            model_name='artist',
            name='origin',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='artists', to='api.Place'),
        ),
        migrations.AddField(
            model_name='artist',
            name='owner',
